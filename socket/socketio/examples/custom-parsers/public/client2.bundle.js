...
const msgpack = __webpack_require__(54);
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_RESULT__;( // Module boilerplate to support browser globals and browserify and AMD.
   true ? function (m) { !(__WEBPACK_AMD_DEFINE_FACTORY__ = (m),
...
const customParser = __webpack_require__(52);
const socket = __webpack_require__(24)('http://localhost:3002', {
  parser: customParser
});
