...
$("input")
  .focus(function(){$(".hot-words").css("display","none");})
  .blur(function(){$(".hot-words").css("display","block");});
...
//热门推荐Box-----------------------
$(".hotlessionbox").mouseenter(function(){
  var _this = $(this);
  _this.addClass("hotlessionboxFocus")
    .siblings().removeClass("hotlessionboxFocus");

  $("#"+_this.attr("id")+"Box").addClass("hot-lessionbox-focus")
    .siblings().removeClass("hot-lessionbox-focus");
});
